...
func GoogleAuthRoute(r *gin.Engine, db *gorm.DB) {
	...
	{
		nonProtected.GET("/auth/google/:entity", handler.GoogleAuth)
		nonProtected.GET("/auth/google/:entity/callback", handler.GoogleAuthCallback)
		nonProtected.GET("/auth/google/:entity/login", handler.GoogleAuth)
		nonProtected.GET("/auth/google/:entity/login/callback", handler.GoogleAuthCallback)
	}
}
